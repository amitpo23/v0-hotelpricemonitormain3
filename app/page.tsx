...
export default function Home() {
  ...
  const content = {
    en: {
      badge: "AI-Powered Revenue Autopilot",
      title1: "Your Hotel Revenue",
      title2: "Cockpit",
      subtitle: "Set your destination, engage Autopilot, watch revenue soar",
      description: "Real-time competitor analysis, 30-day price forecasting powered by 8 AI agents working together to optimize your pricing strategy 24/7.",
      cta1: "Enter Cockpit",
      cta2: "Watch Demo",
      trust1: "Enterprise Security",
      trust2: "5-Min Setup",
      trust3: "No Commitment",
      valueTitle: "Why Choose the",
      valueHighlight: "Cockpit Platform",
      valueSubtitle: "8 specialized AI agents analyzing millions of data points in real-time, making intelligent pricing decisions while you focus on guests",
      ...
      feature2Title: "Real-Time Competitor Radar",
      ...
      feature4Title: "Autopilot Mode",
      feature4Desc: "Enable Autopilot and the system updates prices automatically 24/7. Set your revenue target and let AI navigate you there",
      feature4Badge: "8 AI agents working",
      feature5Title: "Revenue Target Lock",
      feature5Desc: "Set monthly revenue goals and the system adjusts pricing strategy to achieve them. Autopilot keeps you on course",
      feature5Badge: "Real-time tracking",
      feature6Title: "Flight Analytics",
      ...
      stat1Value: "25%",
      stat1Label: "Average Altitude Gain",
      stat2Value: "30+",
      stat2Label: "Days Flight Plan",
      stat3Value: "24/7",
      stat3Label: "Autopilot Active",
      stat4Value: "8",
      stat4Label: "AI Agents",
      processTitle: "Your Flight Plan",
      processSubtitle: "Configure once, optimize continuously",
      step1Title: "Pre-Flight Check",
      step1Desc: "System collects pricing from competitors, occupancy data, and information about local events",
      step2Title: "AI Co-Pilots Analyze",
      step2Desc: "8 specialized AI agents analyze the data and identify patterns, trends, and opportunities",
      step3Title: "Route Calculation",
      step3Desc: "System generates optimal price forecasts for every night, 30 days in advance",
      step4Title: "Engage Autopilot",
      step4Desc: "Receive alerts and pricing recommendations or enable Autopilot for automatic price updates",
    },
    he: {
      badge: "טייס אוטומטי לניהול הכנסות",
      title1: "קוקפיט ניהול הכנסות",
      title2: "למלון שלך",
      subtitle: "הגדירו יעד, הפעילו טייס אוטומטי, צפו בהכנסות ממריאות",
      description: "ניתוח מתחרים בזמן אמת, תחזיות מחירים ל-30 יום מבוססות 8 סוכני AI שעובדים יחד כדי לייעל את אסטרטגיית התמחור 24/7.",
      cta1: "כניסה לקוקפיט",
      cta2: "צפה בהדגמה",
      ...
      valueHighlight: "פלטפורמת הקוקפיט",
      valueSubtitle: "8 סוכני AI מתמחים מנתחים מיליוני נקודות מידע בזמן אמת, מקבלים החלטות תמחור חכמות בזמן שאתם מתמקדים באורחים",
      ...
      feature2Title: "מכ\"ם ניתוח מתחרים",
      ...
      feature4Title: "מצב טייס אוטומטי",
      feature4Desc: "הפעילו טייס אוטומטי והמערכת תעדכן מחירים 24/7. הגדירו יעד הכנסות ותנו ל-AI לנווט אתכם לשם",
      feature4Badge: "8 סוכני AI עובדים",
      feature5Title: "נעילת יעד הכנסות",
      feature5Desc: "הגדירו יעדי הכנסה חודשיים והטייס האוטומטי יתאים את התמחור להשגתם. שומרים על המסלול",
      feature5Badge: "מעקב בזמן אמת",
      feature6Title: "ניתוח טיסה",
      feature6Desc: "ראו את הביצועים לאורך זמן, השוו למתחרים וזהו הזדמנויות לשיפור",
      feature6Badge: "תובנות מבוססות נתונים",
      stat1Value: "25%",
      stat1Label: "עלייה ממוצעת בגובה",
      stat2Value: "30+",
      stat2Label: "ימי תכנית טיסה",
      stat3Value: "24/7",
      stat3Label: "טייס אוטומטי פעיל",
      stat4Value: "8",
      stat4Label: "סוכני AI",
      processTitle: "תכנית הטיסה שלך",
      processSubtitle: "הגדרה חד-פעמית, אופטימיזציה מתמשכת",
      step1Title: "בדיקה לפני הטיסה",
      step1Desc: "המערכת אוספת נתוני מחירים ממתחרים, נתוני תפוסה ומידע על אירועים באזור",
      step2Title: "טייסי ה-AI מנתחים",
      step2Desc: "8 סוכני AI מתמחים מנתחים את הנתונים ומזהים דפוסים, מגמות והזדמנויות",
      step3Title: "חישוב מסלול",
      step3Desc: "המערכת יוצרת תחזיות מחיר אופטימליות לכל לילה ל-30 יום קדימה",
      step4Title: "הפעלת טייס אוטומטי",
      step4Desc: "קבלו התראות והמלצות או הפעילו טייס אוטומטי לעדכוני מחירים אוטומטיים",
    }
  }
